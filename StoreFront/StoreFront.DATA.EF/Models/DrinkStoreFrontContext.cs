...
{
    public partial class DrinkStoreFrontContext : DbContext
    {
        public DrinkStoreFrontContext()
        {
        }

        public DrinkStoreFrontContext(DbContextOptions<DrinkStoreFrontContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\sqlexpress;Database=DrinkStoreFront;Trusted_Connection=true;Encrypt=false;MultipleActiveResultSets=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.OrderTime).HasColumnType("time(3)");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.UnitSizeFlOunce).HasColumnType("decimal(5, 2)");

                entity.Property(e => e.UnitWeightLbs)
                    .HasColumnType("decimal(3, 2)")
                    .HasColumnName("UnitWeightLBS");
